  ...
  <ContentWrapper name='help'>
    <Content name='help'>
      ...
      <div className='wrap p-b-2'>
        ...
        <p>
          If you want to get familiar with HiGlass and public Hi-C data we recommend you check out
          <a href='#tutorial-2017-4dn-annual-meeting'>4D Nucleome Annual Meeting Tutorial</a>.
          If you want to know more about data processing and analysis have a look at our tutorial
          from <a href='#tutorial-2017-4dn-annual-meeting'>ISMB / ECCB 2017</a>.
        ...
        <ul className='no-list-style large-spacing'>
          <li id='tutorial-2017-4dn-annual-meeting'>
            ...
            <p>
              ...
              visually explore sequencing-based 3D genome data as well as how to get started using
          ...
          <li id='tutorial-2017-'>
            ...
            <p>
              After this tutorial you are able to obtain, process, analyze, and visualize 3D genome
              data on their own as well as to understand some of the logic, motivation and pitfalls
              associated with common operations such as matrix balancing and multi-resolution
              visualization.
            </p>
          </li>
        </ul>
        ...
        <ul className='no-list-style large-spacing'>
          <li>
            ...
            <p>
              For developer questions regarding APIs etc. please refer to our extensive documention.
            </p>
          </li>
          <li>
            <strong>Bugs: </strong>
          ...
          <li>
            ...
            <p>
              Utilize the community and ask question on how to get started on
              Stackoverflow and the likes.
            </p>
          </li>
        </ul>
